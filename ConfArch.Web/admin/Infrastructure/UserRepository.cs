...
namespace Kentico.Admin
{
    public class UserRepository : IUserRepository
    {
        ...
        {
            new User { Id = 1, Name = "andy", Password = "ydna", FavoriteColor = "blue", Role = "editor", ExternalId = null },
            new User { Id = 2, Name = "admin", Password = "nimda", FavoriteColor = "blue", Role = "admin", ExternalId = null },
            new User { Id = 3, Name = "datagrid.sk@gmail.com", Password = null, FavoriteColor = "orange", Role = "", ExternalId = "105838370131173562976" }
        });
